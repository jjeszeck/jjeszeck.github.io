...
app.layouts = [
  ...
  ,
    ...
    text: [
      'Drawings of an autistic artist'
      '2006 BEST IN SHOW Award Publishers Association of the West'
    ]
    publisher: 'PRINCETON ARCHITECTURAL PRESS'
    image_count: 2
  ,
  ...
  ,
    ...
    slug: 'PlanetIce'
    text: [
      'Photographic account of the rapidly changing ice on Earth'
      '2009 Atmospheric Science Librarians International CHOICE AWARD'
    ]
    publisher: 'MOUNTAINEERS BOOKS'
    image_count: 2
  ,
  ...
  ,
    ...
    text: [
      'Ideas for repurposing local materials to create containers, pathways, and lighting'
      '2011 GOLD MEDAL Design Winner<br>Garden Writer\'s Association'
    ]
    publisher: 'TIMBER PRESS'
    image_count: 2
  ,
